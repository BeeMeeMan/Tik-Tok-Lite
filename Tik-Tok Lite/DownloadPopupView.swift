            ...
            VStack {
                ...
                VStack {
                    ...
                    if isLoading {
                        ...
                        .task {
                            do {
                                try await dataStorage.tiktokTemp = StorageModel.downloadTikTok(by: UIPasteboard.general.string!)
                            } catch {
...
//        print(clip)
        ...
        //                            let index = downloader.playlistArray.firstIndex(of: playlist!)
        //                            downloader.playlistArray[index!].videoArr.append(newItem.fileName)
        //
